...
user1 = User.create!(first_name: "Bob", last_name: "Smith", nickname: "Bobby", gender: "male", age: 37, location: uk_cities.sample, email: "bobby@smith.com", password: "123456", about: "City professional who wants to find likeminded friends. I love art,theatre and books. Keen to exchange my reading list and form a bookclub. ", avatar_url: "https://www.biography.com/.image/t_share/MTgwMjk3MjI5MjU5NTE1MDMw/gettyimages-3315233.jpg")
...
user7 = User.create!(first_name: "Emma", last_name: "Baker", nickname: "Emma", gender: "female", age: 28, location: uk_cities.sample, email: "emma@baker.com", password: "123456", about: "Keen traveller and explorer, Want to find some nice friends to enjoy this beautiful city with.", avatar_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f2/Gal_Gadot_by_Gage_Skidmore_2.jpg/1200px-Gal_Gadot_by_Gage_Skidmore_2.jpg")
